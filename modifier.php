...
if ($tbl['agent_id'] == $_SESSION['agent_id']){
  ...
  $bdd = 'UPDATE annonces SET titre = :new_titre, description = :new_description, type = :new_type, prix = :new_prix, postal_code = :new_code_postal, city = :new_city WHERE id = :id';
  ...
  $value->bindValue(':new_code_postal', $postal_code);
  $value->bindValue(':new_city', $city);
  $value->bindValue(':id', $_POST['id'], PDO::PARAM_INT);
  
  if($value->execute()){
    $_SESSION['flash']  = "Votre annoonce à été modifiée.";
  ...
  <main>
    <div class="container section--sm">
      ...
      <div class="form-page">
        ...
        <form action="modifier.php?id=<?= $tbl['id'] ?>" method="POST" class="form-stack">
